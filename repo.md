...
* <a href="https://github.com/Azure/wvdquickstart/tree/main/AADDS" target="_blank">AADDS</a>: In this folder, there's the QuickStart ARM template that is used when you start with an empty subscription.
