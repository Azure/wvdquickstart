...
* <a href="https://github.com/Azure/wvdquickstart/blob/main/ARMRunbookScripts/checkCredentials.ps1" target="_blank">checkAzureCredentials.ps1</a>: This script makes sure that the entered Azure Admin credentials are correct.
